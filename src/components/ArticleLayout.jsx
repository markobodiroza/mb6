          ...
          <div className="mx-auto max-w-2xl">
            ...
            <article>
              <header className="flex flex-col">
                ...
                <time
                  dateTime={meta.date}
                  className="order-first flex items-center text-base text-slate-500 dark:text-slate-200"
                >
                  <span className="h-4 w-0.5 rounded-full bg-slate-500 dark:bg-slate-200" />
