...
export default function Projects() {
  ...
  return (
    <>
    <NextSeo
      title="Projects - Marko Bodiroza"
      description={siteMeta.description}
      canonical="https://markobodiroza.com/projects"
      openGraph={{
        url: 'https://markobodiroza.com/projects',
        images: [
          {
            url: `https://og.markobodiroza.com/api/og?title=Projects&desc=${headline}`,
            width: 1200,
            height: 600,
            alt: 'Og Image Alt',
            type: 'image/jpeg',
        ...
        >
          {projects.map((project) => (
            <Card as="li" key={project.name}>
              ...
              <p className="relative z-10 mt-6 flex text-sm font-medium text-neutral-400 transition group-hover:text-emerald-500 dark:text-neutral-200">
