...
export default function Speaking() {
  return (
    <>
    <NextSeo
      title="Speaking - Marko Bodiroza"
      description={siteMeta.description}
      canonical="https://markobodiroza.com/speaking"
      openGraph={{
        url: 'https://markobodiroza.com/speaking',
        images: [
          {
            url: `https://og.markobodiroza.com/api/og?title=Speaking&desc=I’ve spoken at events all around the world and been interviewed for many podcasts.`,
            width: 1200,
            height: 600,
            alt: 'Og Image Alt',
            type: 'image/jpeg',
